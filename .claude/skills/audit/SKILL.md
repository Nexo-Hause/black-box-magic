---
name: audit
description: Ejecutar auditoría completa de un spec o plan antes de implementar. Analiza arquitectura, seguridad, UX, performance, completitud y puntos ciegos en 3 fases, luego enriquece el plan original. Use when user mentions auditing a spec, plan, or feature before implementation.
disable-model-invocation: false
user-invocable: true
allowed-tools: Read, Grep, Glob, Bash, Task, Write, Edit
argument-hint: [spec-number o path-archivo]
---

# Auditoría Pre-Implementación

Ejecutar auditoría completa de un spec o plan antes de implementar.
...
- **Observación** — Riesgo bajo, considerar
- **OK** — Sin problemas detectados

### Gate Fase 1 a Fase 2

- Si hay **críticos**: PAUSAR. Presentar hallazgos al usuario y esperar decisión antes de continuar.
- Si solo hay **observaciones y OK**: Informar hallazgos brevemente y continuar automáticamente a Fase 2.
...
### Gate Fase 2 a Fase 3

- Si hay **críticos**: PAUSAR. Presentar hallazgos al usuario y esperar decisión.
- Si solo hay **observaciones y OK**: Informar y continuar automáticamente a Fase 3.
...
**Fecha:** [fecha]
**Resultado global:** [Aprobado | Aprobado con observaciones | Requiere cambios]
...
3. **Ser accionable.** Cada hallazgo crítico u observación debe incluir una recomendación concreta de cómo resolverlo.
