...
CREATE UNIQUE INDEX IF NOT EXISTS idx_assignments_form ON bbm_planogram_assignments (form_id);
CREATE INDEX IF NOT EXISTS idx_assignments_planogram ON bbm_planogram_assignments (planogram_id);
